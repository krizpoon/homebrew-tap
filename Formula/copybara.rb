class Copybara < Formula
  ...
  on_macos do
    url "https://github.com/krizpoon/copybara-releases/releases/download/v2.1.3/copybara-app.zip"
    sha256 "008275867e4195ade1dc37688d5224b17dae48735e5e66d28bebfa299a13449b"
  end
