class Copybara < Formula
  ...
  on_macos do
    url "https://github.com/krizpoon/copybara-releases/releases/download/v1.6.0/copybara-app.zip"
    sha256 "a61ed530e789b62a9ed0f0f5b50ba299c79cf87ba52818942356685ea09dffc2"
  end
